...
const setup1 = () => {
  ...
  animator.lineAnimationSpeed = 0.5;
  animator.globalRotationSpeed = 2.4 ** 2 / 2;
  const fullCircle = 2760;
  drawCtMax = fullCircle;
  animator.baseColor = color(175, 100, 50);
  animator.maxAlphaLine = 0.06;
  animator.minAlphaLine = 0.01;
  animator.maxLumLineCore = 80;
  animator.minLumLineCore = 30;
  animator.coreLumVarSpeed = 0.26;
